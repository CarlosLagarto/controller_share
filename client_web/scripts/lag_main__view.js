...
var main_view = function(){
	...
	this.__reset_page = function(panel){
		...
		if(self._prev_tab_panel){ // REVIEW - damn event is beeing called twice - have to investigate and improve
	...
	this.__nav_to = function(nav_to_elem, inClass, outClass){
	    ...
	    show(nav_to_elem);
	    if (inClass) {	
			void nav_to_elem.offsetWidth; // anination trigger for repetition
    ...
    this.footer_default_yes_response_snackbar = document.getElementById("footer_default_yes_response_snackbar");
